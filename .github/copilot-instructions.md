Objective:
- Mettre a jour le fichier [insert_test_data.py](../src/apps/aquariums/management/commands/insert_test_data.py) avec la base de donnée 

- Ajouter des données de test pour les modèles suivants : 
  - Aquarium
  - Analyse
  - Traitement
  - ChangeEau
  ...
  - Plante
  - Equipement
- Utiliser des données réalistes pour chaque modèle, en veillant à ce qu'elles soient cohérentes entre elles ().
